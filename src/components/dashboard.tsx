          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <Button
                ...
                className="bg-gradient-primary hover:opacity-90 text-white font-semibold group shadow-glow"
              >
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <GlassCard className="animate-slide-up" style={{ animationDelay: '0.3s' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    className="group cursor-pointer p-6 rounded-xl bg-gradient-primary/10 border border-primary/20 hover:bg-gradient-primary/20 transition-all duration-300"
                    onClick={onStartTailoring}
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <ArrowRight className={`w-5 h-5 text-primary transition-transform ${hoveredCard === 'tailor' ? 'translate-x-1' : ''}`} />
                    </div>
                    <h3 className="text-xl font-semibold text-white mb-2">Tailor Resume</h3>
                    <p className="text-white/70">Match your resume to any job description with AI precision</p>
                  </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <ArrowRight className={`w-5 h-5 text-secondary transition-transform ${hoveredCard === 'history' ? 'translate-x-1' : ''}`} />
                    </div>
                    <h3 className="text-xl font-semibold text-white mb-2">View History</h3>
                    <p className="text-white/70">Access all your previously tailored resumes</p>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="animate-slide-up" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-accent/10 border border-accent/20">
                    <p className="text-white font-medium mb-2">💡 Trending Skills</p>
                    <p className="text-white/70 text-sm">Add "React 18", "TypeScript", and "Cloud Architecture" to boost your profile for tech roles.</p>
                  </div>
                  
                  <div className="p-4 rounded-lg bg-primary/10 border border-primary/20">
                    <p className="text-white font-medium mb-2">🎯 Optimization Tip</p>
                    <p className="text-white/70 text-sm">Your last resume scored 94% match. Try emphasizing leadership experience for management roles.</p>
                  </div>
                </div>
              </GlassCard>
            </div>
            ...
            <div className="space-y-6">
                    ...
                    recentResumesList.map((resume, index) => (
                      <div key={resume.id} className="flex items-center justify-between p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-white font-medium text-sm">{resume.title} - {resume.company}</p>
                            <p className="text-white/50 text-xs">{new Date(resume.created_at).toLocaleDateString()}</p>
                          </div>
                        </div>
              ...
              {/* Pro Tip */}
              <GlassCard className="animate-slide-up" style={{ animationDelay: '0.6s' }}>
